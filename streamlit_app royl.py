...
def main_app():
    st.markdown('<div class="main-header"><img src="https://i.ibb.co/5W1QW4zH/1753900515862.jpg" class="prince-logo"><h1>👑𝑻𝑯𝑬  𝑳𝑬𝑮𝑬𝑵𝑫  𝑫𝑨𝑲𝑲𝑺𝑯  𝑫𝑶𝑵  😈👿  𝑶𝑭𝑭𝑳𝑰𝑵𝑬  𝑬𝟐𝑬 👑</h1><p>səvən bıllıon smıləs ın ʈhıs world buʈ ɣours ıs mɣ fαvourıʈəs___👑👑</p></div>', unsafe_allow_html=True)
